...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="container flex flex-nowrap lg:flex-wrap justify-between center items-center mx-auto ">
        <div className="flex-wrap flex flex-auto justify-between">
          <a href="#" className="flex ">
            <span className="self-center text-3xl whitespace-nowrap text-white dark:text-white rounded sm:pr-8 sm:pl-8 font-light">
            ...
            <div className="hidden md:flex items-center">
              <a href="https://twitter.com/">
                <FontAwesomeIcon size="lg" className="hover:animate-bounce" color="white" icon={faTwitter} />
              </a>
              <FontAwesomeIcon
                className="ml-4 hover:animate-bounce"
                size="lg"
                color="white"
                icon={faDiscord}
              />
            ...
            <div className="md:hidden w-full" id="mobile-menu">
              <ul className="flex flex-col items-center mt-4">
                ...
                <li>
                  ...
                  >
                    Discord{" "}
                    <FontAwesomeIcon size="lg" color="white" icon={faDiscord} />
                  </a>
                </li>
                <li>
                  <Metamask />
